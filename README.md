...
2. Clone this repo
```
git clone https://github.com/DarrenRatcliffe/IoT-Demo
cd summit2017
```
...
```
oc create -n redhat-iot -f https://raw.githubusercontent.com/jboss-openshift/application-templates/master/jboss-image-streams.json
oc create -n redhat-iot -f https://raw.githubusercontent.com/openshift/origin/master/examples/image-streams/image-streams-centos7.json
```
